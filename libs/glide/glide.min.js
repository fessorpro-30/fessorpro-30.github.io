...
! function (t, e) {
  ...
  function h(t, e) {
    var n = a({}, t, e);
    return e.hasOwnProperty("classes") && (n.classes = a({}, t.classes, e.classes), e.classes.hasOwnProperty("direction") && (n.classes.direction = a({}, t.classes.direction, e.classes.direction)), e.classes.hasOwnProperty("type") && (n.classes.type = a({}, t.classes.type, e.classes.type)), e.classes.hasOwnProperty("slide") && (n.classes.slide = a({}, t.classes.slide, e.classes.slide)), e.classes.hasOwnProperty("arrow") && (n.classes.arrow = a({}, t.classes.arrow, e.classes.arrow)), e.classes.hasOwnProperty("nav") && (n.classes.nav = a({}, t.classes.nav, e.classes.nav))), e.hasOwnProperty("breakpoints") && (n.breakpoints = a({}, t.breakpoints, e.breakpoints)), n
  }
  var v = (t(e, [{
    key: "on",
    value: function (t, e) {
  ...
  var p = (t(m, [{
    ...
    value: function (t) {
      ...
      return this._e.emit("mount.before"), u(e) && (this._c = function (t, e, n) {
        ...
        for (var s in i) c(i[s].mount) && i[s].mount();
        return i
  ...
  function b(n, i, r) {
    ...
    function l() {
      c = !1 === r.leading ? 0 : g(), s = null, a = n.apply(o, u), s || (o = u = null)
    }
    ...
    function t() {
      ...
      c || !1 !== r.leading || (c = t);
      var e = i - (t - c);
      return o = this, u = arguments, e <= 0 || i < e ? (s && (clearTimeout(s), s = null), c = t, a = n.apply(o, u), s || (o = u = null)) : s || !1 === r.trailing || (s = setTimeout(l, e)), a
    }
    return t.cancel = function () {
      clearTimeout(s), c = 0, s = o = u = null
    }, t
  }
  var w = {
  ...
  var H = (t(T, [{
    ...
    value: function (t, e, n, i) {
      ...
      o(t) && (t = [t]);
      for (var s = 0; s < t.length; s++) this.listeners[t[s]] = n, e.addEventListener(t[s], this.listeners[t[s]], r)
    }
  }, {
    key: "off",
  ...
  function P(i, r, s) {
    var o = [function (t, n) {
      return {
        modify: function (t) {
          var e = Math.floor(t / n.Sizes.slideWidth);
          return t + n.Gaps.value * e
        }
      }
    }, function (t, e) {
      return {
    ...
    return {
      mutate: function (t) {
        for (var e = 0; e < o.length; e++) {
          var n = o[e];
          c(n) && c(n().modify) && (t = n(i, r, s).modify(t))
        }
        return t
      }
    }
  ...
  var W = {
    Html: function (e, t) {
      ...
      return d(n, "root", {
        ...
        set: function (t) {
          o(t) && (t = document.querySelector(t)), k(t) && (n._r = t)
        }
      }), d(n, "track", {
        get: function () {
          return n._t
    ...
    Translate: function (i, r, n) {
      var s = {
        set: function (t) {
          var e = P(i, r).mutate(t);
        ...
        getStartIndex: function () {
          var t = r.Sizes.length,
            e = i.index,
            n = i.settings.perView;
          return r.Run.isOffset(">") || r.Run.isOffset("|>") ? t + (e - n) : (e + n) % t
        },
      ...
      return n.on("move", function (t) {
        if (!i.isType("carousel") || !r.Run.isOffset()) return s.set(t.movement);
        r.Transition.after(function () {
          n.emit("translate.jump"), s.set(r.Sizes.slideWidth * i.index)
        });
        var e = r.Sizes.slideWidth * r.Translate.getStartIndex();
        return s.set(e - r.Translate.getTravelDistance())
    ...
    Gaps: function (e, s, t) {
      ...
      return d(n, "value", {
        ...
        n.apply(s.Html.wrapper.children)
      }, 30)), t.on("destroy", function () {
        n.remove(s.Html.wrapper.children)
      }), n
    },
    Move: function (t, i, r) {
      var e = {
    ...
    Clones: function (v, p, t) {
      var e = {
        ...
        collect: function (t) {
          for (var e = 0 < arguments.length && void 0 !== t ? t : [], n = p.Html.slides, i = v.settings, r = i.perView, s = i.classes, o = r + +!!v.settings.peek + Math.round(r / 2), u = n.slice(0, o).reverse(), a = n.slice(-1 * o), c = 0; c < Math.max(1, Math.floor(r / n.length)); c++) {
            for (var l = 0; l < u.length; l++) {
              var f = u[l].cloneNode(!0);
              f.classList.add(s.slide.clone), e.push(f)
            }
            for (var d = 0; d < a.length; d++) {
              var h = a[d].cloneNode(!0);
              h.classList.add(s.slide.clone), e.unshift(h)
            }
          }
          return e
        },
        append: function () {
          for (var t = this.items, e = p.Html, n = e.wrapper, i = e.slides, r = Math.floor(t.length / 2), s = t.slice(0, r).reverse(), o = t.slice(-1 * r).reverse(), u = p.Sizes.slideWidth + "px", a = 0; a < o.length; a++) n.appendChild(o[a]);
          for (var c = 0; c < s.length; c++) n.insertBefore(s[c], i[0]);
      ...
      var e = {
        ...
        activeClass: function () {
          var e = i.settings.classes,
            t = r.Html.slides[i.index];
          t && (t.classList.add(e.slide.active), _(t).forEach(function (t) {
            t.classList.remove(e.slide.active)
          }))
        },
        removeClasses: function () {
          var t = i.settings.classes,
            e = t.type,
            n = t.slide;
          r.Html.root.classList.remove(e[i.settings.type]), r.Html.slides.forEach(function (t) {
    ...
    Run: function (u, n, i) {
      var a = {
        ...
        make: function (t) {
          var e = this;
          u.disabled || (u.settings.waitForTransition && u.disable(), this.move = t, i.emit("run.before", this.move), this.calculate(), i.emit("run", this.move), n.Transition.after(function () {
            e.isStart() && i.emit("run.start", e.move), e.isEnd() && i.emit("run.end", e.move), e.isOffset() && (e._o = !1, i.emit("run.offset", e.move)), i.emit("run.after", e.move), u.enable()
          }))
        },
        calculate: function () {
          var t = this.move,
          ...
          if ("=" !== i)
            if (">" !== i || ">" !== n)
              if ("<" !== i || "<" !== n) {
                if ("|" === i && (r = u.settings.perView || 1), ">" === i || "|" === i && ">" === n) {
                  var s = function (t) {
                    var e = u.index;
                    if (u.isType("carousel")) return e + t;
                    return e + (t - e % t)
                  }(r);
                  return e < s && (this._o = !0), void(u.index = function (t, e) {
                    var n = a.length;
                    if (t <= n) return t;
                    if (u.isType("carousel")) return t - (n + 1);
                    if (u.settings.rewind) return a.isBound() && !a.isEnd() ? n : 0;
                    if (a.isBound()) return n;
                ...
                if ("<" === i || "|" === i && "<" === n) {
                  var o = function (t) {
                    var e = u.index;
                    if (u.isType("carousel")) return e - t;
                    return (Math.ceil(e / t) - 1) * t
                  }(r);
                  return o < 0 && (this._o = !0), void(u.index = function (t, e) {
                    var n = a.length;
                    if (0 <= t) return t;
                    if (u.isType("carousel")) return t + (n + 1);
                    if (u.settings.rewind) return a.isBound() && a.isStart() ? n : Math.floor(n / e) * e;
                    return 0
                  }(o, r))
                }
              } else u.index = 0;
        ...
        isOffset: function (t) {
          var e = 0 < arguments.length && void 0 !== t ? t : void 0;
        ...
        isBound: function () {
          return u.isType("slider") && "center" !== u.settings.focusAt && u.settings.bound
        }
      };
      return d(a, "move", {
        get: function () {
        ...
        get: function () {
          ...
          return this.isBound() ? e - 1 - (y(t.perView) - 1) + y(t.focusAt) : e - 1
        }
      }), d(a, "offset", {
        get: function () {
          return this._o
        ...
        t = {
          ...
          move: function (t) {
            if (!d.disabled) {
              ...
              t.stopPropagation(), h.Move.make(o * function (t) {
                return parseFloat(t)
            ...
            if (!d.disabled) {
              var e = d.settings,
                ...
                u = s.pageX - m,
                a = 180 * p / Math.PI;
              this.enable(), o < u && a < i ? h.Run.make(h.Direction.resolve(n + "<")) : u < -o && a < i ? h.Run.make(h.Direction.resolve(n + ">")) : h.Move.make(), h.Html.root.classList.remove(r.dragging), this.unbindSwipeMove(), this.unbindSwipeEnd(), v.emit("swipe.end")
            }
          },
          bindSwipeStart: function () {
            var e = this,
              ...
              n = t.swipeThreshold,
              i = t.dragThreshold;
            n && r.on(L[0], h.Html.wrapper, function (t) {
              e.start(t)
            }, s), i && r.on(L[1], h.Html.wrapper, function (t) {
              e.start(t)
            }, s)
          },
          unbindSwipeStart: function () {
            r.off(L[0], h.Html.wrapper, s), r.off(L[1], h.Html.wrapper, s)
          },
          bindSwipeMove: function () {
            var e = this;
            r.on(R, h.Html.wrapper, b(function (t) {
              e.move(t)
            }, d.settings.throttle), s)
          },
          unbindSwipeMove: function () {
            r.off(R, h.Html.wrapper, s)
          },
          bindSwipeEnd: function () {
            var e = this;
            r.on(D, h.Html.wrapper, function (t) {
              e.end(t)
            })
          },
          unbindSwipeEnd: function () {
            r.off(D, h.Html.wrapper)
          },
          touches: function (t) {
          ...
          enable: function () {
            return n = !1, h.Transition.enable(), this
          },
          disable: function () {
            return n = !0, h.Transition.disable(), this
          }
        };
      return v.on("build.after", function () {
        h.Html.root.classList.add(d.settings.classes.swipeable)
      }), v.on("destroy", function () {
        t.unbindSwipeStart(), t.unbindSwipeMove(), t.unbindSwipeEnd(), r.destroy()
      }), t
    },
      ...
      var n = new H,
        ...
        s = {
          ...
          addClass: function (t) {
            var e = i.settings,
              n = t[i.index];
            n && (n.classList.add(e.classes.nav.active), _(n).forEach(function (t) {
              t.classList.remove(e.classes.nav.active)
            }))
          },
          removeClass: function (t) {
            var e = t[i.index];
            e && e.classList.remove(i.settings.classes.nav.active)
          },
    ...
    Breakpoints: function (t, e, n) {
      ...
      return a(r, u.match(s)), i.on("resize", window, b(function () {
        t.settings = h(r, u.match(s))
  ...
  return function (t, e) {
    ...
    value: function (t) {
      ...
      }(B.prototype.__proto__ || Object.getPrototypeOf(B.prototype), "mount", this).call(this, a({}, W, e))
    }
  }]), B
});